...
public class CenterServiceImpl implements CenterService {
    ...
    public Center addCenter(Center center) {
        Optional<Center> centerList = centerRepository.findById(center.getCenPhone());
    ...
    public Center editCenter(Center center) {
        return centerRepository.findById(center.getCenName())
                .map(center1 -> {
                    center1.setCenPhone(center.getCenPhone());
                    center1.setCenAddress(center.getCenAddress());
                    center1.setCenName(center.getCenPhone());
